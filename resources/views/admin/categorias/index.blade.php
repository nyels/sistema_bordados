                    ...
                    <table id="example1" class="table table-bordered table-hover table-condensed">
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr style="text-align: center;" data-id="{{ $category->id }}">
                                    <td>{{ $loop->iteration }}</td>
                                    <td class="nombre-categoria">{{ mb_strtoupper($category->name, 'UTF-8') }}</td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="create_name"
                                name="name" placeholder="Ej: Plantas"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="edit_name"
                                name="name" placeholder="Ej: VESTIDOS"
                                required>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning text-center mt-3">
                        ...
                        <p class="mb-0" style="font-weight: bold; font-size: 16px;">¿Deseas eliminar esta categoria?</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            var newRow = table.row.add([
                                table.rows().count() + 1,
                                '<span class="nombre-categoria">' + response.data.name.toUpperCase() + '</span>',
                                '<button type="button" class="btn btn-warning btn-edit" data-id="' + response.data.id + '" data-nombre="' + response.data.name + '"><i class="fas fa-edit"></i></button> ' +
                                '<button type="button" class="btn btn-danger btn-delete" data-id="' + response.data.id + '" data-nombre="' + response.data.name + '"><i class="fas fa-trash"></i></button>'
                            ]).draw(false).node();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            row.find('.nombre-categoria').text(response.data.name.toUpperCase());
