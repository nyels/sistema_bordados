...
@section('title', 'Editar Nivel de Urgencia')

@section('content_header')
    <h1><i class="fas fa-clock mr-2"></i> Editar Nivel de Urgencia</h1>
@stop
...
@section('content')
    ...
    <form action="{{ route('admin.urgency-levels.update', $urgencyLevel->id) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name"
                                           ...
                                           value="{{ old('name', $urgencyLevel->name) }}" maxlength="100" required>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sort_order" id="sort_order"
                                           ...
                                           value="{{ old('sort_order', $urgencyLevel->sort_order) }}" min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="time_percentage" id="time_percentage"
                                               ...
                                               value="{{ old('time_percentage', $urgencyLevel->time_percentage) }}" min="1" max="200" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="price_multiplier" id="price_multiplier"
                                               ...
                                               value="{{ old('price_multiplier', $urgencyLevel->price_multiplier) }}" min="0.5" max="5" step="0.05" required>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="color" id="colorPicker" value="{{ old('color', $urgencyLevel->color) }}"
                                               style="width: 50px; height: 38px; padding: 2px;">
                                        <input type="text" name="color" id="color"
                                               class="form-control @error('color') is-invalid @enderror"
                                               value="{{ old('color', $urgencyLevel->color) }}" maxlength="20" required>
                                    </div>
                                    @error('color')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i id="iconPreview" class="fas {{ $urgencyLevel->icon ?? 'fa-clock' }}"></i></span>
                                        </div>
                                        <input type="text" name="icon" id="icon"
                                               class="form-control @error('icon') is-invalid @enderror"
                                               value="{{ old('icon', $urgencyLevel->icon) }}" maxlength="50"
                                               placeholder="fa-clock, fa-bolt">
                                    </div>
                                    @error('icon')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" rows="2"
                                      ...
                                      maxlength="500">{{ old('description', $urgencyLevel->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body text-center">
                        <div id="preview" class="p-3 rounded mb-3" style="background-color: #f8f9fa;">
                            <span id="previewBadge" class="badge p-2" style="background-color: {{ $urgencyLevel->color }}; color: white; font-size: 1.1rem;">
                                <i class="fas {{ $urgencyLevel->icon ?? 'fa-clock' }} mr-1"></i> <span id="previewName">{{ $urgencyLevel->name }}</span>
                            </span>
                        </div>
                        <div class="text-left">
                            <p class="mb-1"><strong>Tiempo:</strong> <span id="previewTime">{{ $urgencyLevel->time_percentage }}</span>% del normal</p>
                            <p class="mb-1"><strong>Precio:</strong> x<span id="previewPrice">{{ number_format($urgencyLevel->price_multiplier, 2) }}</span></p>
                        </div>
                    </div>
                </div>
