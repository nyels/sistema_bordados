...
@section('content')
    ...
    <div class="card card-danger">
        ...
        <div class="card-body pt-3 pb-2">
            <form id="deleteForm" method="POST" action="{{ route('admin.material-categories.destroy', $category->id) }}">
                @csrf
                @method('DELETE')
                ...
                <div class="text-center pb-3">
                    <a href="{{ route('admin.material-categories.index') }}" class="btn btn-secondary shadow-sm">
