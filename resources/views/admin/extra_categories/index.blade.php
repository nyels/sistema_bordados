...
@section('title', 'CATEGORÍAS DE EXTRAS')
...
@section('content')
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title" style="font-weight: bold;font-size: 20px;"> CATEGORÍAS DE EXTRAS</h3>
        </div>
        <div class="card-body">
            <div class="row">
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr style="text-align: center;" data-id="{{ $category->id }}">
                                    ...
                                    <td class="nombre-categoria">{{ $category->nombre }}</td>
                                    <td><span class="badge badge-info">{{ $category->extras_count }}</span></td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="create_nombre"
                                name="nombre" placeholder="Ej: EMPAQUE"
    ...
    <script>
        $(function() {
            ...
            $('#formCreate').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route("admin.extra_categories.store") }}',
                    type: 'POST',
                    ...
                    error: function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            if (errors && errors.nombre) {
                                ...
                                $('#create_nombre').addClass('is-invalid');
                                $('#create_error_nombre').text(xhr.responseJSON.message);
                            }
                        } else {
                            $('#modalCreate').modal('hide');
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $('#edit_id').val(id);
                $('#edit_nombre').val(nombre).removeClass('is-invalid');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            row.find('.nombre-categoria').text(response.data.nombre);
                    ...
                    error: function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            if (errors.nombre) {
                                $('#edit_nombre').addClass('is-invalid');
                                $('#edit_error_nombre').text(errors.nombre[0]);
                            }
                        } else {
                            $('#modalEdit').modal('hide');
            ...
            $('#btnConfirmDelete').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: '/extra_categories/delete/' + id,
                            type: 'DELETE',
