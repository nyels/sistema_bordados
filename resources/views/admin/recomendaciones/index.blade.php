                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            var newRow = table.row.add([
                                table.rows().count() + 1,
                                '<span class="nombre-recomendacion">' + response.data.nombre_recomendacion + '</span>',
                                '<button type="button" class="btn btn-warning btn-edit" data-id="' + response.data.id + '" data-nombre="' + response.data.nombre_recomendacion + '"><i class="fas fa-edit"></i></button> ' +
                                '<button type="button" class="btn btn-danger btn-delete" data-id="' + response.data.id + '" data-nombre="' + response.data.nombre_recomendacion + '"><i class="fas fa-trash"></i></button>'
                            ]).draw(false).node();
